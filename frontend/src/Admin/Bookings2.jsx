  ...
  return (
    <>
      <div>
        ...
        <Link to="/admin/bookings"className='mb-5 ms-5'><FaArrowLeft  style={{fontSize:'25px' }}/>previous</Link>
        <Link to="/admin/bookings3" className='mb-5 ms-5'><FaArrowRight style={{fontSize:'25px' }}/>Next</Link>
